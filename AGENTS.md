...
- `.claude/rules/cakephp-plugin/` — CakePHP plugin conventions (project structure, composer.json, CI, coding practices, code quality, README template, testing)
- `.claude/rules/phpunit/` — PHPUnit testing guidelines (AAA pattern, assertions, data providers, bypass-finals)
- `.claude/rules/php/` — PHP coding guidelines